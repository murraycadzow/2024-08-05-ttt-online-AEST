...
humandate: "5-8 August 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9am - 1 pm AEST/ 11am - 3pm NZST"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Masami Yamaguchi", "Murray Cadzow", "Arindam Basu", "Mik Black"] # boxed, comma-separated list of trainers' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: [""]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
contact: ["instructor.training@carpentries.org", "murray.cadzow@otago.ac.nz"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
